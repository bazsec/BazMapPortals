            ...
            blocks = {
                { type = "table",
                  ...
                  rows = {
                      ...
                      { "/mp set",   "Save a custom coord override for the destination under your cursor" },
                      { "/mp clear", "Clear all custom overrides" },
                      { "/mp dump",  "Dump current overrides for inspection" },
                      { "/mp info",  "Show diagnostic info about pin placement" },
                  },
                },
            },
        },
